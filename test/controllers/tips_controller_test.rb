...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { content: @tip.content, strategy_id: @tip.strategy_id, title: @tip.title }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { content: @tip.content, strategy_id: @tip.strategy_id, title: @tip.title }
    assert_redirected_to tip_path(assigns(:tip))
  end
